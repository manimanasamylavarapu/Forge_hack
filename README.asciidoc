== Forge_StartHack
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The Forge_StartHack addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>Forge_StartHack</artifactId>
